...
function footerCountText() {
  let [remaining, _] = stats();
  return Plural(remaining, "task") + " left";
}

function completedCount() {
  let [_, completed] = stats();
  return completed;
}
...
function TodoItem(t) {
  return {Mount(___p) {
    ...
    ___e1.setAttribute("data-id", String(t.id));
    const ___e2 = document.createElement("input");
    ___e2.setAttribute("type", "checkbox");
    ___e2.className = "todo-cb";
    ___e2.setAttribute("data-action", "toggle");
    ___e2.setAttribute("data-todo-id", String(t.id));
    if(t.done)___e2.setAttribute("checked", "");
    ___e1.appendChild(___e2);
    const ___e3 = document.createElement("span");
    ___e3.className = "todo-text";
    ___e3.appendChild(document.createTextNode(String(t.text)));
    ___e1.appendChild(___e3);
    if (t.isUrgent()) {
      const ___e4 = document.createElement("span");
      ___e4.className = "badge";
      ___e4.appendChild(document.createTextNode("urgent"));
      ___e1.appendChild(___e4);
    }
    const ___e5 = document.createElement("button");
    ___e5.className = "del-btn";
    ___e5.setAttribute("type", "button");
    ___e5.setAttribute("data-action", "delete");
    ___e5.setAttribute("data-todo-id", String(t.id));
    ___e5.appendChild(document.createTextNode("✕"));
    ___e1.appendChild(___e5);
...
function TodoList(visible) {
  return {Mount(___p) {
    ...
    if (__len(visible) === 0) {
      const ___e7 = document.createElement("li");
      ___e7.className = "empty";
      ___e7.appendChild(document.createTextNode("Nothing here."));
...
function FilterButton(f, active) {
  return {Mount(___p) {
    ...
    ___e8.setAttribute("data-filter", String(f));
    switch (f) {
      case FilterAll: {
        ___e8.appendChild(document.createTextNode("All"));
      break; }
      case FilterActive: {
        ___e8.appendChild(document.createTextNode("Active"));
      break; }
      case FilterCompleted: {
        ___e8.appendChild(document.createTextNode("Completed"));
      break; }
    }
    ___p.appendChild(___e8);
  }};
}
  ...
  return {Mount(___p) {
    ...
    if (__len(todos) > 0) {
      ...
      if (completedCount() > 0) {
        ...
        ___e12.setAttribute("type", "button");
        ___e12.setAttribute("data-action", "clear-completed");
        ___e12.appendChild(document.createTextNode("Clear ("));
        ___e12.appendChild(document.createTextNode(String(completedCount())));
        ___e12.appendChild(document.createTextNode(")"));
        ___e10.appendChild(___e12);
      }
    }
    ___p.appendChild(___e10);
  }};
}
...
function Header(hc, msg, cls) {
  return {Mount(___p) {
    ...
    ___e15.className = "header-top";
    const ___e16 = document.createElement("div");
    ___e16.className = "header-icon";
    ___e16.appendChild(document.createTextNode("✓"));
    ___e15.appendChild(___e16);
    const ___e17 = document.createElement("h1");
    ___e17.appendChild(document.createTextNode("Todos Templ"));
    ___e15.appendChild(___e17);
    if (hc > 0) {
      const ___e18 = document.createElement("span");
      ___e18.className = "high-badge";
      ___e18.appendChild(document.createTextNode(String(hc)));
    ...
    ___e19.appendChild(document.createTextNode("Built with"));
    const ___e20 = document.createElement("a");
    ___e20.setAttribute("href", "https://github.com/seriva/gofront");
    ___e20.setAttribute("target", "_blank");
    const ___e21 = document.createElement("strong");
    ___e21.appendChild(document.createTextNode("GoFront"));
    ___e20.appendChild(___e21);
    ___e19.appendChild(___e20);
    ___e19.appendChild(document.createTextNode("— Go compiled to JS"));
    ___e14.appendChild(___e19);
    ___p.appendChild(___e14);
  }};
}
...
function InputRow(highPri, errMsg) {
  return {Mount(___p) {
    ...
    ___e23.setAttribute("autocomplete", "off");
    ___e22.appendChild(___e23);
    const ___e24 = document.createElement("button");
    ___e24.className = priorityBtnClass(highPri);
    ___e24.setAttribute("type", "button");
    ___e24.setAttribute("data-action", "priority");
    ___e24.appendChild(document.createTextNode(String(priorityBtnText(highPri))));
    ___e22.appendChild(___e24);
    const ___e25 = document.createElement("button");
    ___e25.className = "add-btn";
    ___e25.setAttribute("type", "button");
    ___e25.setAttribute("data-action", "add");
    ___e25.appendChild(document.createTextNode("Add"));
    ___e22.appendChild(___e25);
    if (errMsg !== "") {
      const ___e26 = document.createElement("span");
      ___e26.className = "error-msg";
      ___e26.appendChild(document.createTextNode(String(errMsg)));
      ___e22.appendChild(___e26);
    } else if (highPri) {
      const ___e27 = document.createElement("span");
      ___e27.className = "priority-hint";
      ___e27.appendChild(document.createTextNode("⚡ High priority — task will be marked urgent"));
      ___e22.appendChild(___e27);
    }
    ___p.appendChild(___e22);
  }};
}
...
function StatsBar(n) {
  return {Mount(___p) {
    ...
    ___e29.setAttribute("data-action", "filter-active");
    const ___e30 = document.createElement("strong");
    ___e30.appendChild(document.createTextNode(String(n)));
    ___e29.appendChild(___e30);
    ___e29.appendChild(document.createTextNode(String(todosWord(n))));
    ___e29.appendChild(document.createTextNode("in session"));
    ___e28.appendChild(___e29);
    ___p.appendChild(___e28);
  }};
}
