...
function FilterButton(f, active) {
  return {Mount(___p) {
    ...
    ___e8.appendChild(document.createTextNode(String(filterLabel(f))));
...
function InputRow(highPri, errMsg) {
  return {Mount(___p) {
    ...
    if (highPri) {
      ...
      ___e26.className = "priority-hint";
      ___e26.appendChild(document.createTextNode("⚡ High priority — task will be marked urgent"));
      ___e22.appendChild(___e26);
    }
    if (errMsg !== "") {
      const ___e27 = document.createElement("span");
      ___e27.className = "error-msg";
      ___e27.appendChild(document.createTextNode(String(errMsg)));
